        ...
        <section className="w-full bg-white z-20 relative -mt-0 shadow-lg border-b border-stone-100">
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-stone-100">
                    ...
                    {/* DIY Option */}
                    <Link href="/quote?type=supply_only" className="group flex-1 py-10 px-6 flex items-center justify-center gap-6 hover:bg-mcb-paper transition-colors cursor-pointer">
                        ...
                        <div>
                            ...
                            <p className="text-stone-500 text-sm">Order custom made blinds & curtains (Supply Only).</p>
                        </div>
                    </Link>

                    {/* Installation Option */}
                    <Link href="/quote?type=installation" className="group flex-1 py-10 px-6 flex items-center justify-center gap-6 hover:bg-mcb-paper transition-colors cursor-pointer">
